...
(function () {
  ...
  const DECISIONS = () => [
    ...
    ['Proposed 25% platform fee (from the Projects prototype)', 'Proposed, not final. Project flows label it: clients see an all-in rate (rate ÷ 0.75), operators see take-home (budget × 0.75). Profiles show the operator\'s own rate. Proposed: no fee on deals operators bring themselves.'],
